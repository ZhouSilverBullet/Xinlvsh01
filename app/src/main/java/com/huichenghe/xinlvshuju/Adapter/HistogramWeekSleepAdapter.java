 ...
 */
public class HistogramWeekSleepAdapter extends RecyclerView.Adapter<HistogramWeekSleepAdapter.MyHolders>
{
    ...
    public HistogramWeekSleepAdapter(Context mContext, ArrayList<Histogram_sleep_entity> dataList)
    {
    ...
    {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_for_week_sleep_histogram, parent, false);
