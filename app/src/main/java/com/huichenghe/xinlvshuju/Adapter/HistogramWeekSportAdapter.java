 ...
 */
public class HistogramWeekSportAdapter extends RecyclerView.Adapter<HistogramWeekSportAdapter.MyHolders>
{
    ...
    public HistogramWeekSportAdapter(Context mContext, ArrayList<stepAndCalorieEntity> dataList)
    {
    ...
    {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_for_week_sport_histogram, parent, false);
