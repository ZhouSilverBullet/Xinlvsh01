...
public class BleForPhoneAndSmsRemind extends BleBaseDataManage
{
            ...
            switch (msg.what)
            {
                ...
                case PHONE_OPEN_MSG:
                    ...
                    else
                    {
                        if(count < 4)
                        {
                            continueSendPhoneHandler(this, msg);
                            openThePhoneAndSmsRemind((byte)msg.arg1, (byte)msg.arg2);
                        }
                        else
                        {
                ...
                case PHONE_READ_STATE:
                    ...
                    else
                    {
                        ...
                        {
                            readPhoneRemind();
                            continueReadPhoneStatus(this, msg);
                        }
    ...
    {
        Message mzg = handler.obtainMessage();
        mzg.what = PHONE_OPEN_MSG;
        mzg.arg1 = msg.arg1;
        mzg.arg2 = msg.arg2;
        Bundle bundle = msg.getData();
        mzg.setData(bundle);
        handler.sendMessageDelayed(mzg, SendLengthHelper.getSendLengthDelay(bundle.getInt("send_length"), bundle.getInt("rece_length")));
        count ++;
    }
    ...
    public void openPhoneRemine(byte ba, byte sw)
    {
        ...
        phoneHandler.sendMessageDelayed(msg, SendLengthHelper.getSendLengthDelay(sendLg, 8));
    }
    ...
    public void readPhoneRemindStatus()
    {
        ...
        Message msg = phoneHandler.obtainMessage();
        msg.what = PHONE_READ_STATE;
        msg.arg1 = sendLg;
        msg.arg2 = 9;
        phoneHandler.sendMessageDelayed(msg, SendLengthHelper.getSendLengthDelay(sendLg, 9));
    }
...
//                pnum = allData;
    ...
    public void dealOpenResponse(byte[] bufferTmp)
    {
        ...
        {
            isReadStatus = true;
            readListener.sendSuccess(bufferTmp);
        }
    }
