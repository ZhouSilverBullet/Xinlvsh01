...
import com.huichenghe.xinlvshuju.ForgroundService;
...
import com.huichenghe.xinlvshuju.slide.settinga.NotificationSendHelper;
...
//                        this.removeMessages(REFRESH_NOTIFICATION);
//                        new BleDataForDayData(getApplicationContext()).requestDayDate();
//                        this.sendEmptyMessageDelayed(REFRESH_NOTIFICATION, 30 * 1000);
//                    break;
//            }
//        }
//    };
    ...
    public static void printCharacteristicProperty(BluetoothGattCharacteristic characteristic){
        ...
        Log.i(TAGBLE, "PROPERTY_BROADCAST         :"+ ((BluetoothGattCharacteristic.PROPERTY_BROADCAST & property) != 0));
        Log.i(TAGBLE, "PROPERTY_EXTENDED_PROPS    :"+ ((BluetoothGattCharacteristic.PROPERTY_EXTENDED_PROPS & property) != 0));
        Log.i(TAGBLE, "PROPERTY_INDICATE          :"+ ((BluetoothGattCharacteristic.PROPERTY_INDICATE & property) != 0));
        Log.i(TAGBLE, "PROPERTY_NOTIFY            :"+ ((BluetoothGattCharacteristic.PROPERTY_NOTIFY & property) != 0));
        Log.i(TAGBLE, "PROPERTY_READ              :"+ ((BluetoothGattCharacteristic.PROPERTY_READ & property) != 0));
        Log.i(TAGBLE, "PROPERTY_SIGNED_WRITE      :"+ ((BluetoothGattCharacteristic.PROPERTY_SIGNED_WRITE & property) != 0));
        Log.i(TAGBLE, "PROPERTY_WRITE             :"+ ((BluetoothGattCharacteristic.PROPERTY_WRITE & property) != 0));
        Log.i(TAGBLE, "PROPERTY_WRITE_NO_RESPONSE :"+ ((BluetoothGattCharacteristic.PROPERTY_WRITE_NO_RESPONSE & property) != 0));
    }
...
//                        blueHandler.sendEmptyMessageDelayed(REFRESH_NOTIFICATION, 30 * 1000);
        ...
        {
            Log.i(TAGBLE, "发送升级数据返回状态吗：" + status);
            LocalDeviceEntity device = Engine.getInstance().getDeviceFromGatt(gatt);
...
//                					}
    ...
    private void notifyAndSendBrocast(List<BluetoothGattService> list, BluetoothGatt gatt, LocalDeviceEntity device)
    {
...
//        Log.i(TAGBLE, "回调接口size:" + mServiceCallbacks.size());
    }
...
//    	debug.printStackTrace();
        ...
        Log.e(TAGBLE, "-----connect-----" + device.getName());
//         mBluetoothGatt.connect();

        Log.d(TAGBLE, "Trying to create a new connection.");
        return true;
    }
        ...
        if (BluetoothAdapter.getDefaultAdapter().isEnabled())
        {
                ...
                if (main != null) {
                    try {
                        ...
                        Log.i(TAGBLE, "使能uuid:" + characteristic.getUuid().toString()
                                + "使能状态：" + isTrue);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
...
//			}
    ...
    public void onCreate()
    {
        ...
        notificationSendHelper = new NotificationSendHelper(this.getApplicationContext());
//        setForground();
    }
...
//        startForeground(459, new Notification());
    ...
    public final String RECEVER_NOTIFICATION = "recever_notification_from_listenerservice";
    ...
    private void registDayDataRecever()
    {
        ...
        intentFilter.addAction(RECEVER_NOTIFICATION);
        ...
        public void onReceive(Context context, Intent intent) {    
            ...
            if(BluetoothDevice.ACTION_BOND_STATE_CHANGED.equals(action)){    
                ...
                case BluetoothDevice.BOND_BONDED:    
                    ...
                    Log.i(TAGBLE, "完成配对 needReConn:" + needReConn);
                    if(needReConn){
...
//                });
            ...
            else if(intent.getAction().equals(RECEVER_NOTIFICATION))
            {
